...
### Problem Statement
Given a set of short strings, and originating author, is it possible to predict
an author given an unlabeled random string. I will be attempting to use 
...
informed models. The solution is clearly defined, especially as Kaggle
...
between the correct class and the others. 
